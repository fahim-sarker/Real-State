...
const Hero = () => {
  return (
    <>
      <section className="py-[200px] bg-heroimg bg-center bg-cover">
        <Container>
          ...
          <p className="mb-9 font-popins font-medium text-white sm:text-lg sm:leading-[1.44] w-[650px] mx-auto text-center">
